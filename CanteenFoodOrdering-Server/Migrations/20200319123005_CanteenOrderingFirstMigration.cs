...
{
    public partial class CanteenOrderingFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderedDishHistories", x => x.OrderedDishHistoryId);
                    table.ForeignKey(
                        name: "FK_OrderedDishHistories_DishHistories_DishHistoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderedDishId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(nullable: false),
                    DishId = table.Column<int>(nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderedDishHistories_DishHistoryId",
                table: "OrderedDishHistories",
                column: "DishHistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderedDishHistories_OrderHistoryId",
                table: "OrderedDishHistories",
